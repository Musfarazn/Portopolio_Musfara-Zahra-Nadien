    ...
    <div class="bg-white rounded-xl shadow-lg flex max-w-4xl w-full overflow-hidden">
        ...
        <div class="w-1/2 p-10 flex flex-col justify-center">
            ...
            <p class="text-sm text-center mt-4 text-gray-600">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-blue-500 font-semibold">Register</a>
            </p>
        </div>

        <!-- Right Side (Image) -->
        <div class="w-1/2 bg-teal-600 flex items-center justify-center">
            <img src="<?php echo e(asset('img/login.png')); ?>" alt="Illustration" class="w-[800px] h-auto">
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\deteksi\resources\views/auth/login.blade.php ENDPATH**/ ?>