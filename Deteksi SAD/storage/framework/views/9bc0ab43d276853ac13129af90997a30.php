    ...
    <div class="bg-white rounded-2xl shadow-lg flex overflow-hidden w-[850px]">
        ...
        <div class="w-1/2 p-10 flex flex-col justify-center">
            ...
            <p class="text-center text-sm mt-4">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-teal-600 font-semibold hover:underline">Login</a>
            </p>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\deteksi\resources\views/auth/register.blade.php ENDPATH**/ ?>